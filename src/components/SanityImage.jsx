...
import { imageAttrs } from '../utils/sanity.image';

export function SanityImage({ image, preset = 'workCard', alt = '', className = '', imgClassName = '', loading = 'lazy', decoding = 'async', fetchPriority = 'auto', onClick, sizes }) {
