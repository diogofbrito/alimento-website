		...
		<div>
			...
			<div className='grid grid-cols-4 gap-x-[50px]  px-5 '>
				<div className='col-span-2 mt-16 '>
					...
					autem nesciunt sequi! Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat itaque autem inventore beatae impedit voluptates magnam ipsa, in excepturi magni iste esse nesciunt quod
					tempora sunt perferendis. Voluptas, dolore eaque.
				...
				<div className='col-span-2 h-[calc(100vh-0px)] pt-16 overflow-y-auto '>
					{recipe.gallery?.map((img, i) => (
						<div key={i} className='w-full pb-5'>
							<AnimatedImage src={urlFor(img).width(1600).quality(80).auto('format').url()} alt={recipe.title} className='w-full  object-cover' />
						</div>
					))}
				</div>
			</div>
