		...
		<div>
			<div className='grid lg:grid-cols-4 lg:gap-x-[100px]'>
				<div className='block col-span-2'>
					<div className='lg:sticky top-0 lg:h-screen h-[50vh] overflow-hidden'>
						<LocalImage src={bg} alt='Patrícia Gabriel' className='w-full h-full' imgClassName='w-full h-full object-cover object-[10%_center]' loading='eager' fetchPriority='high' />
					</div>
				</div>
				...
				<div className='pt-[40px] lg:pt-[100px] col-span-2 lg:pl-0 px-3'>
					...
					<div className='grid grid-cols-2 lg:gap-x-[100px]'>
						<div className='col-span-1 mt-[60px] flex flex-col'>
							...
							<AnimatedPAfterH1>Para marcações ou workshops contactar bla bla... Lorem</AnimatedPAfterH1>
						</div>
